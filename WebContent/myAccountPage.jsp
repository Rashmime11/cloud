...
else if (option.equalsIgnoreCase("VIEWBILL"))
{
...
<div id="mainWrapper" class="mainWrapper">
  ...
  <header> 
    ...
    <div id="myDropdownArea" class="dropdown">
		...
		<div id="fullCart" class="fullCart"><a href="#" title="Cart" onclick="myCartManage()" id="VIEWFULLCARD"><img src="images/cart.jpg" width="20" height="20"></a></div> 		
  ...
  <div class="body_section">
	      ...
	      <div id="menubar">
	        <nav class="menu">
	          	<table>
	          		...
	          		<tr>
	          			<td>
	          				<a href="myAccountPage.jsp?option=VAS&type=subscribed" id="MYSUBSCRIPTION">My Subscriptions</a>
	          			</td>
	       		  </tr>
	          		<tr>
	          			<td>
	       				  <a href="myAccountPage.jsp?option=ALLMEDIA&type=download" id="MYCOLLECTION">My Collections</a>
	          			</td>
	       		  </tr>
	          		<!-- <tr>
	          			<td>
	       				  <a href="myAccountPage.jsp?option=VIEWBILL" id="MYBILL">View My Bill</a>
	          			</td>
	       		  </tr> -->
	       		  </tbody>
	          	</table>
	        ...
	        <nav class="menu">
	          <center>
	          	<table>
	          		...
	          		<tr>
	          			<td>
	       				  <a href="myAccountPage.jsp?option=VAS&type=unsubscribed" id="VALUEADDED">Value Added Services</a>
	          			</td>
	       		  </tr>
	       		  </tbody>
	          	</table>
	        ...
	        <nav class="menu">
	          <center>
	          	<table>
	          		...
	          		<tr>
	          			<td>
	       				  <a href="myAccountPage.jsp?option=GAMES" id="GAMEAPPS">Games & Apps</a>
	          			</td>
	       		  </tr>
	          		<tr>
	          			<td>
	       				  <a href="myAccountPage.jsp?option=MOVIES" id="MOVIES">Movies</a>
	          			</td>
	       		  </tr>
	          		<tr>
	          			<td>
	       				  <a href="myAccountPage.jsp?option=MUSIC" id="MUSICS">Music</a>
	          			</td>
	       		  </tr>
	          		<tr>
	          			<td>
	...
	if (option.equalsIgnoreCase("VIEWBILL") )
	{
